...
const createAvatarUrl = (name: string): string =>
  `https://avatar.vercel.sh/${encodeURIComponent(name)}.svg?size=48&background=0F172A&color=F8FAFC`;

const customers = [
  {
    id: 'USR-010',
    name: 'Alcides Antonio',
    avatar: createAvatarUrl('Alcides Antonio'),
  ...
  },
  {
    id: 'USR-009',
    name: 'Marcus Finn',
    avatar: createAvatarUrl('Marcus Finn'),
  ...
  },
  {
    id: 'USR-008',
    name: 'Jie Yan',
    avatar: createAvatarUrl('Jie Yan'),
  ...
  },
  {
    id: 'USR-007',
    name: 'Nasimiyu Danai',
    avatar: createAvatarUrl('Nasimiyu Danai'),
  ...
  },
  {
    id: 'USR-006',
    name: 'Iulia Albu',
    avatar: createAvatarUrl('Iulia Albu'),
  ...
  },
  {
    id: 'USR-005',
    name: 'Fran Perez',
    avatar: createAvatarUrl('Fran Perez'),
...

  {
    id: 'USR-004',
    name: 'Penjani Inyene',
    avatar: createAvatarUrl('Penjani Inyene'),
  ...
  },
  {
    id: 'USR-003',
    name: 'Carson Darrin',
    avatar: createAvatarUrl('Carson Darrin'),
  ...
  },
  {
    ...
    avatar: createAvatarUrl('Siegbert Gottfried'),
  ...
  },
  {
    id: 'USR-001',
    name: 'Miron Vitold',
    avatar: createAvatarUrl('Miron Vitold'),
